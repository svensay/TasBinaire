...
public class Main {
	...
	TBQueue<Integer> t = new TBQueue<Integer>(10);
	...
	QueueExt<Integer> fil = t.filtre(new Predicate<Integer>() {
		public boolean test(Integer x){
		    return x.intValue() >= 1 && x.intValue() <= 5;
		}
	    });
	...
	TBQueue<String> g = new TBQueue<String>(10);
